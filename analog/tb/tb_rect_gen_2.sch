...
N 1220 -240 1220 -220 {lab=VOUT}
N 860 -240 920 -240 {lab=VO2}
N 1080 -240 1080 -220 {lab=VOUT}
N 1080 -160 1080 -120 {lab=VSS}
N 1080 -240 1220 -240 {lab=VOUT}
N 1000 -240 1080 -240 {lab=VOUT}
...
N 1220 -60 1220 -20 {lab=VSS}
N 1220 -160 1220 -120 {lab=#net1}
...
C {vsource.sym} 0 -190 0 1 {name=V1 value="dc 0 sin(0 500m 403Meg)" savecurrent=false}
...
C {lab_pin.sym} 1220 -240 0 1 {name=p8 sig_type=std_logic lab=VOUT}
...
C {capa.sym} 1080 -190 0 0 {name=C6
m=1
value=0.1n
footprint=1206
device="ceramic capacitor"}
C {lab_pin.sym} 1080 -140 0 1 {name=p12 sig_type=std_logic lab=VSS}
...
C {res.sym} 1220 -90 0 0 {name=R1
value=160k
footprint=1206
device=resistor
m=1}
C {lab_pin.sym} 1220 -40 0 1 {name=p4 sig_type=std_logic lab=VSS}
C {vsource.sym} 1220 -190 0 0 {name=V3 value=0 savecurrent=false}

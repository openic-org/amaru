...
N 300 -440 300 -400 {lab=VSS}
N 800 -360 800 -340 {lab=#net2}
N 680 -510 760 -510 {lab=#net3}
N 720 -360 800 -360 {lab=#net2}
N 800 -380 800 -360 {lab=#net2}
N 460 -360 520 -360 {lab=#net1}
C {capa.sym} 900 -390 0 0 {name=C1
m=1
value=253.58n
footprint=1206
device="ceramic capacitor"}
C {vsource.sym} 300 -270 0 0 {name=V1 value=1.3 savecurrent=false}
C {gnd.sym} 300 -240 0 0 {name=l1 lab=GND}
C {vsource.sym} 380 -270 0 0 {name=V2 value=0 savecurrent=false}
C {gnd.sym} 380 -240 0 0 {name=l2 lab=GND}
C {lab_pin.sym} 300 -320 0 1 {name=p1 sig_type=std_logic lab=VDD}
C {vsource.sym} 300 -470 0 0 {name=V3 value=0.6 savecurrent=false}
C {lab_pin.sym} 380 -320 0 1 {name=p5 sig_type=std_logic lab=VSS}
...
C {lab_pin.sym} 300 -520 0 1 {name=p2 sig_type=std_logic lab=VREF}
C {ngspice_probe.sym} 740 -360 0 0 {name=r4}
C {lab_pin.sym} 300 -420 0 1 {name=p3 sig_type=std_logic lab=VSS}
C {loopgainprobe.sym} 620 -360 0 0 {name=X999}

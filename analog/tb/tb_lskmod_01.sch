...
N 580 -340 800 -340 {lab=VIN}
N 580 -620 800 -620 {lab=VIP}
N 460 -620 580 -620 {lab=VIP}
N 360 -620 460 -620 {lab=VIP}
N 740 -480 760 -480 {lab=VSS}
N 800 -620 800 -540 {lab=VIP}
N 800 -420 800 -340 {lab=VIN}
...
"}
C {lab_pin.sym} 740 -480 0 0 {name=p9 sig_type=std_logic lab=VSS}
...
footprint=1206
device="ceramic capacitor"}
C {lskmod_gen.sym} 800 -480 0 0 {name=x1}
